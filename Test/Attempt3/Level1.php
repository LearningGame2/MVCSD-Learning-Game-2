...
<body onload="NextQuestion(0)">
  <h1 style="color:white; text-align:center; font-family: 'Lucida Console', 'Courier New', monospace; font-size:300%; top:-10px; line-height:100px;">
    Level 1
  </h1>
    <main>
...
function handleEndGame() {
        ...
        const playerGrade = (amountCorrect / 8) * 100
