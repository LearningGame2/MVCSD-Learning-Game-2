...
<body style="background-image:url('./LG2Images/duck-meet.jpg'); background-size:cover;" onload="NextQuestion(0)">
    ...
    <!-- end of modal of quiz details-->
        ...
        <div class="game-quiz-container" style = "position:relative; top:-150px">
            ...
            <div class="game-details-container" style="justify-content:center;">
              <h1 id = "multiplier-message">HexGL Multiplier: <span id = "player-minigamemulti"></span></h1>
            </div>
...
function handleNextQuestion() {
        ...
        setTimeout(() => {
            if (indexNumber <= 4) { //for 5 questions: changed from 10
